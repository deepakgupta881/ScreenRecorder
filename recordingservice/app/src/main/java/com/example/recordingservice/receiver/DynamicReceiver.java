...
public class DynamicReceiver {
    ...
    DynamicReceiver(BroadcastReceiver receiver) {
    ...
    /**
     * create a {@link DynamicReceiver} that handles registration for {@link BroadcastReceiver}
     * at run-time, it also reads any declared annotation on the {@link BroadcastReceiver} ...
     * you can then override the annotations values through the builder methods in the
     * {@link DynamicReceiver} it-self
     *
     * @param receiver the {@link BroadcastReceiver}
     * @return a {@link DynamicReceiver} to handle run-time registration
     */
    public static DynamicReceiver with(BroadcastReceiver receiver) {
        return new DynamicReceiverInitializer().apply(receiver);
    }
